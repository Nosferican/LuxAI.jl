"""
    INPUT_CONSTANTS :: Dict{String, String}

Constants used in the communications API.
"""
const INPUT_CONSTANTS = Dict("RESEARCH_POINTS" => "rp",
                             ...
                             "DONE" => "D_DONE")
"""
    DIRECTIONS_OUTPUT :: Dict{String, String}

Constants used in the communications API for directions.
"""
